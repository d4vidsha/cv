...
\section{Education}
  \resumeSubHeadingListStart
    % \resumeSubheading
    %   {Master of IT (specialisation in AI)}{Feb. 2024 -- Nov. 2026}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Software Engineer Intern}{Sep. 2023 -- Present}
      {Sincidium}{Melbourne, VIC}
      \resumeItemListStart
        \resumeItem{Developed the frontend of a web application using TypeScript and React for a startup}
        \resumeItem{Developed CI pipeline using GitHub Actions following best practices}
      \resumeItemListEnd
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Created helpful video tutorials on YouTube to help others learn n8n and programming}
    \resumeItemListEnd
