...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Recreate frontend and backend \texttt{Dockerfile}s for an 87.8\% reduction in image sizes}
        \resumeItem{Speed up build and deployment times by 90\%}
        \resumeItem{Improve developer experience using linters, opinionated formatters}
